...
static inline __u32 __swab32(__u32 val)
{
	return ___constant_swab32(val);
}

static inline __u64 __swab64(__u64 val)
{
...
void sha256_update(struct sha256_state *sctx, const void *buf, size_t size)
{
	...
	memcpy(sctx->buf + partial, src, size - done);
}
...
{
	return memcmp(a.d, b.d, sizeof(a.d));
}
